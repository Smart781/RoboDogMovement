...
namespace MBaske
{
    public class Body : MonoBehaviour
    {
        ...
        public Vector3 ManagedReset(bool randomizeRotation = false, Vector3 position = default)
        {
            ...
            Vector3 new_Pos = m_DefPos + new Vector3(Random.Range(-2, 2), 0, Random.Range(-2, 2));

            m_Body.TeleportRoot(
                position.Equals(default) ? new_Pos : position,
                randomizeRotation
